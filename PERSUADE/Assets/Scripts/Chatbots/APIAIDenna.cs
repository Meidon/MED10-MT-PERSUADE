...
public class APIAIDenna : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        const string ACCESS_TOKEN = "ba7b549e08614f4cb39326d42117ce5e";
        animRespond = false;
        //isSending = false;
    ...
    public void SendText()
    {
        ...
        if (response != null)
        {
            ...
            n.textInput = "Denna: " + answerTextField.text;
