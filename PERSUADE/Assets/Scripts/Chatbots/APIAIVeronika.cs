...
public class APIAIVeronika : MonoBehaviour
{
    ...
    public Narrator n;
    public LogSystem lS;
    private string botName = " | Veronika: ";
    ...
    void Start()
    {
        ...
        const string ACCESS_TOKEN = "cedcf06b401746d4a1d3581969a15929";
        animRespond = false;
        //isSending = false;
    ...
    public void SendText()
    {
        ...
        if (response != null)
        {
            ...
            n.textInput = "Veronika: " + answerTextField.text;
