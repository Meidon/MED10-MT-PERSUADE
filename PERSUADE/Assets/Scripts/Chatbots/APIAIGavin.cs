...
public class APIAIGavin : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        const string ACCESS_TOKEN = "e3239131f3314dfa871d35f87a6bca62";
        animRespond = false;
        //isSending = false;
    ...
    public void SendText()
    {
        ...
        if (response != null)
        {
            ...
            n.textInput = "Gavin: " + answerTextField.text;
